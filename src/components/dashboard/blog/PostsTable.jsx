...
export default function PostsTable({ user }) {
  ...
  return (
    <>
      <Card>
        <CardContent>
          <Typography variant="h5">Visualizar usuarios y Bancos</Typography>
          ...
          */}
          ...
          {
            posts.length === 0 && <Typography align="center" style={{marginTop: '20px'}}>No se ha podido cargar la informacion desde la base de datos.</Typography>
          }
        </CardContent>
      </Card>
